...
export default function Description() {
  return (
    <div className='container__presentation__card__description'>
      ...
      <p><span>personnality :</span> curious, caring, listening, perfectionnist... a little to much</p>
      <p><span>hobbies :</span> gaming, basketball (I'm a Celtic's fan), photography</p>
    </div>
  )
}